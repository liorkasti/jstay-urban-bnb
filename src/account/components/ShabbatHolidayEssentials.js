...
function ShabbatHolidayEssentials(props) {
  return (
    <View style={[styles.container, props.style]}>
      ...
      <View style={styles.button995Stack}>
      ...
      <View style={styles.button998StackStack}>
        ...
        <View style={styles.button999Stack}>
      ...
      <View style={styles.button1005StackStack}>
      ...
      <View style={styles.button1008StackStack}>
